...
description: "Copy your Claude Code config / Skills / MCPs over"
---
...
## About "Migrating from Claude Code"

Copy your Claude Code config / Skills / MCPs over

Full spec: [PRD.md · §6.7](https://github.com/duolaAmengweb3/mimo-tui/blob/main/PRD.md).
