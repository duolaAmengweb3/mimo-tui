...
description: "/usage shows daily / monthly / cache hits / savings"
---
...
## About "Usage dashboard"

/usage shows daily / monthly / cache hits / savings

Full spec: [PRD.md · §6.10](https://github.com/duolaAmengweb3/mimo-tui/blob/main/PRD.md).
