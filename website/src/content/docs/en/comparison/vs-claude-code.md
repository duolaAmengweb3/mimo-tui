...
description: "Feature matrix + when to pick which"
---
...
## About "vs Claude Code"

Feature matrix + when to pick which

Full spec: [PRD.md · PRD §2-3](https://github.com/duolaAmengweb3/mimo-tui/blob/main/PRD.md).
