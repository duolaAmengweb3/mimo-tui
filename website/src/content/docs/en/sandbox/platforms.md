...
description: "Per-platform implementations and limits"
---
...
Per-platform implementations and limits

Full spec: [PRD.md · §6.9](https://github.com/duolaAmengweb3/mimo-tui/blob/main/PRD.md).
