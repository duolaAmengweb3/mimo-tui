---
title: Plan / Agent / Auto modes
description: "Plan = read-only · Agent = with approval · Auto = full autonomy"
---
...
## About "Plan / Agent / Auto modes"

Plan = read-only · Agent = with approval · Auto = full autonomy

Full spec: [PRD.md · §6.4](https://github.com/duolaAmengweb3/mimo-tui/blob/main/PRD.md).
