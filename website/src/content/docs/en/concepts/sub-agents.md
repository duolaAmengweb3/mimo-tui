---
title: Sub-agents
description: "Up to 10 parallel sub-tasks coordinated by the main agent"
---
...
Up to 10 parallel sub-tasks coordinated by the main agent

Full spec: [PRD.md · §6.5](https://github.com/duolaAmengweb3/mimo-tui/blob/main/PRD.md).
