...
description: "Common sandbox errors per platform"
---
...
## About "Sandbox issues"

Common sandbox errors per platform

Full spec: [PRD.md · —](https://github.com/duolaAmengweb3/mimo-tui/blob/main/PRD.md).
