...
description: "Full schema for ~/.mimo/config.toml"
---
...
## About "config.toml reference"

Full schema for ~/.mimo/config.toml

Full spec: [PRD.md · §6.13](https://github.com/duolaAmengweb3/mimo-tui/blob/main/PRD.md).
